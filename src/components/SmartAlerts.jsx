    ...
    if (sim) {
      ...
      if (regime === 'mei' && receitaAnual > 50000 && receitaAnual < 81000) {
        ...
        alerts.push({
          ...
          message: `A receita anual da empresa (${formatCurrency(receitaAnual)}) está a ${((81000 - receitaAnual) / 81000 * 100).toFixed(1)}% do limite MEI. Planeje a transição para Simples Nacional.`,
          action: 'comparativo',
      ...
      if (receitaMensal > 0) {
        ...
        if (imposto > 0 && (imposto / receitaMensal) > 0.25) {
          alerts.push({
            ...
            message: `Os tributos representam ${((imposto / receitaMensal) * 100).toFixed(1)}% da receita da empresa. Considere otimizar usando o Comparativo de Regimes.`,
            action: 'comparativo',
