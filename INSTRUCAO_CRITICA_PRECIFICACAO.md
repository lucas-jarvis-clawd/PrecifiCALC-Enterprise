# 🚨 INSTRUÇÃO CRÍTICA - PRECIFICAÇÃO
...
**❌ ERRADO - Ambíguo ou confuso:**
- "Sua margem" (margem de quem?)
- "Seus impostos" (do consultor ou cliente?)
...
- Alertas são sobre a empresa DO CLIENTE
- Tributação é da empresa DO CLIENTE

### Relatórios:
- Análises são da empresa DO CLIENTE
- Recomendações são para O CLIENTE
- Cenários são do negócio DO CLIENTE

## 🚨 INSTRUÇÃO PARA AGENTES

**QUALQUER agente que trabalhar no PrecifiCALC deve:**

1. **LER este arquivo PRIMEIRO**
2. **ENTENDER** que é ferramenta para calcular preços de produtos DOS CLIENTES
3. **NUNCA** assumir que Lucas está precificando produtos próprios
4. **SEMPRE** usar linguagem que deixe claro o contexto
5. **PERGUNTAR** em caso de dúvida sobre o contexto

## 📝 HISTÓRICO DO ERRO

**Data:** 05/02/2026  
**Erro:** Agentes assumiram que Lucas estava precificando produtos próprios  
**Correção:** Esta instrução foi criada para nunca mais acontecer  
**Status:** INSTRUÇÃO PERMANENTE - NUNCA DELETAR

---

**REGRA FINAL:** Se você não tem certeza do contexto, PERGUNTE. Não assuma.